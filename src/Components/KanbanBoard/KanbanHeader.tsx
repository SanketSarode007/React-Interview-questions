...
export const KanbanHeader: React.FC = () => {
    return (
        <div className="bg-[#dcdccc] flex items-center px-4">
            <div className="flex flex-1 gap-4 items-center">
                <h1 className="text-2xl text-[#554c3e] font-medium px-4 py-3 ">Kanban Board</h1>
                <div className="bg-[#edeee6] rounded-md px-4 py-2 w-1/2"  >
                    <input type="text" placeholder="Search" className="outline-none w-full" />
                </div>
            </div>
            <div className="hover:bg-[#f5f5f1] p-2 rounded-full cursor-pointer">
