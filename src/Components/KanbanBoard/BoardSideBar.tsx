...
export const BoardSideBar: React.FC = () => {
    ...
    return (
        <div className="px-4 flex py-2 bg-[#dcdccc] rounded-md">
            <ul className="flex flex-col gap-4 py-4">
                <li className="hover:bg-[#f5f5f1] p-2 rounded-full cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" height="26px" viewBox="0 -960 960 960" width="26px" fill="#1f1f1f"><path d="M240-200h120v-240h240v240h120v-360L480-740 240-560v360Zm-80 80v-480l320-240 320 240v480H520v-240h-80v240H160Zm320-350Z" /></svg>
                </li>
                <li className="hover:bg-[#f5f5f1] p-2 rounded-full cursor-pointer">
                ...
                <li className="hover:bg-[#f5f5f1] p-2 rounded-full cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="#1f1f1f"><path d="M280-160v-441q0-33 24-56t57-23h439q33 0 56.5 23.5T880-600v320L680-80H360q-33 0-56.5-23.5T280-160ZM81-710q-6-33 13-59.5t52-32.5l434-77q33-6 59.5 13t32.5 52l10 54h-82l-7-40-433 77 40 226v279q-16-9-27.5-24T158-276L81-710Zm279 110v440h280v-160h160v-280H360Zm220 220Z" /></svg>
                </li>
                <li className="hover:bg-[#f5f5f1] p-2 rounded-full cursor-pointer">
